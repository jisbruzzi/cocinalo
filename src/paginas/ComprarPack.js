...
class ComprarPack extends Component {
  constructor(props) {
    super(props);
    this.state = {
  ...
  costoComprados() {
    return this.props.location.state.itemsCarrito.reduce(
      (total, elem) => total + elem.datosPack.precio, 0)
  }
    ...
    return (
        <div className = {this.props.classes.contenedor}>
                ...
                return (
                  <TableRow key={item.id}>
                    ...
                    <TableCell component="th" scope="row">
                      {item.datosPack.nombre}
                    </TableCell>
                    <TableCell padding='none' numeric>{item.datosPack.precio}</TableCell>
                  </TableRow>
                );
              })}
            </TableBody>
            ...
            <Button
              ...
              variant="contained"
              color="primary"
              onClick={()=>{this.comprarPack(this.props.location.state.itemsCarrito)}}>
...
export default withStyles(styles)(ComprarPack);
